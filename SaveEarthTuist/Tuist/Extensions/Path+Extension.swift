...
extension Path {
  ...
  public static func plistPath(_ plistName: String) -> Path {
    return .relativeToRoot("SaveEarthTuist/InfoPlists/\(plistName).plist")
  }
  
  public static func xcconfigPath(_ xcconfigName: String) -> Path {
    return .relativeToRoot("SaveEarthTuist/XCConfigs/\(xcconfigName).xcconfig")
  }
  
  public static func entitlementPath(_ entitle: String) -> Path {
    return .relativeToRoot("SaveEarthTuist/Projects/SaveEarth/SaveEarth/Entitlements/\(entitle).entitlements")
  }
